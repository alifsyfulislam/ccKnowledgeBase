        ...
        methods: {
            ...
            getCategoryDetails()
            {
                ...
                axios.get(apiUrl+_that.category_id,
                    ...
                    .then(function (response) {
                        if (response.data.status_code === 200) {
                            // console.log(response.data.category_info.parent_id);
                            ...
                            if ((_that.categoryDetails.role_id).includes(',')) {

                                _that.roleAccess        = (_that.categoryDetails.role_id).split(',');
                                _that.roleAccess        = _that.roleAccess.map(i=>Number(i))

                                // console.log(_that.roleAccess);
                            }else{
                                _that.roleAccess.push(_that.categoryDetails.role_id);
                            }
