                                            ...
                                            <v-col class="customer-data-table-wrapper">
                                                <v-data-table :headers="headers" :items="resultList" :search="search" :hide-default-footer=true  class="elevation-1" :items-per-page="20">
                                                    ...
                                                    <template v-slot:item.actions="{item}">
                                                        <button  class="btn btn-info ripple-btn right-side-common-form btn-xs m-1" @click="post_id=item.id, isDeleteCheck=true" v-if="checkPermission('comment-delete')"><i class="fas fa-eye text-white"></i> View Perform Details</button>
                                                    </template>
