        ...
        <div class="right-sidebar-content-area px-2">
          ...
          <div class="form-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-md-12" v-if="selected_language=='bangla'">
                <div class="form-group mb-15">
                  <label for="bn_body">Bangla Body</label>
                  <Summernote  v-model="articleData.bn_body" :idFromParent="bnBody" ></Summernote>
<!--                  <textarea cols="30" rows="6" class="form-control"  v-model="articleData.bn_body" id="bn_body"></textarea>-->
                </div>
              </div>
...
name: "articleAdd.vue",
  ...
  methods: {
    ...
    articleAdd() {
      ...
      let bnBody = document.getElementById('bn_Body').value;
