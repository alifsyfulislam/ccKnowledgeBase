                            ...
                            <table class="table table-bordered gsl-table" v-if="allQuizField">
                                ...
                                <tr v-for="(a_quiz_field,index) in allQuizField" :key="a_quiz_field.id">
                                    ...
                                    <td class="text-center" style="min-width: 120px">
                                        <button class="btn btn-success ripple-btn right-side-common-form btn-xs m-1"  @click="quiz_form_id = a_quiz_field.id, isEditCheck=true"><i class="fas fa-pen"></i></button>
                                        <button  class="btn btn-danger ripple-btn right-side-common-form btn-xs m-1" @click="quiz_form_id = a_quiz_field.id, isDelete=true"><i class="fas fa-trash-restore-alt"></i></button>
                                    </td>
                                </tr>
