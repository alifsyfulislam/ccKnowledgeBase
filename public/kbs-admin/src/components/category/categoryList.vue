                  ...
                  <div class="table-responsive text-nowrap">
                    <table class="table">
                      ...
                      <tr v-for="a_category in categoryList" :key="a_category">
                        <td>{{ a_category.id }}</td>
                        <td>{{ a_category.name }}</td>
                        <td>{{ a_category.parent_recursive ? a_category.parent_recursive.name : ''   }}</td>

                        <td>

                          <a href="#" class="btn btn-info" data-toggle="modal"  :data-target="'#editModal_'+ a_category.id" @click="category_name = a_category.name,  category_parent_id = a_category.parent_id">Edit</a>
                          <div class="modal col-md-offset-2 fade" :id="'editModal_'+ a_category.id" role="dialog">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="col-md-8" v-model="category_name">
                                  </div>
                                </div>

                                <div class="modal-footer">
                                  <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                                  <button @click="categoryUpdate(a_category.id)" type="button" class="btn btn-success" data-dismiss="modal">Update</button>
                                </div>
                              </div>
                            </div>
                          </div>

                          <a href="#" class="btn btn-danger" data-toggle="modal"  :data-target="'#deleteModal_'+ a_category.id">Delete</a>

                          <div class="modal col-md-offset-2 fade" :id="'deleteModal_'+ a_category.id" role="dialog">
                            <div class="modal-dialog">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                                  <button @click="deleteCategory(a_category.id)" type="button" class="btn btn-success" data-dismiss="modal">Delete</button>
                                </div>
                              </div>
                            </div>
                          </div>
